...
{{--                                <h1 class="f-w-700">Get Thousands Premium Courses.</h1><span class="f-light f-w-400 f-14">Upgrade to watch, play, learn, make and discover. </span><a--}}
{{--                                    class="btn btn-square btn-primary f-w-700" href="pricing.html">Go Premium</a>--}}
{{--                            </div>--}}
...
{{--                                    </svg>--}}
{{--                                </button>--}}
{{--                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown1"><a class="dropdown-item" href="#">Weekly </a><a class="dropdown-item" href="#">Monthly </a><a--}}
...
{{--                                    </svg>--}}
{{--                                </button>--}}
{{--                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown2"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item"--}}
{{--                                                                                                                                                            href="#">Monthly </a><a--}}
{{--                                        class="dropdown-item" href="#">Yearly </a></div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                    </svg>--}}
{{--                                </button>--}}
{{--                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown3"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item"--}}
{{--                                                                                                                                                            href="#">Monthly </a><a--}}
{{--                                        class="dropdown-item" href="#">Yearly</a></div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                            </button>--}}
{{--                                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdownes4"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item"--}}
{{--                                                                                                                                                                          href="#">Monthly</a><a--}}
{{--                                                    class="dropdown-item" href="#">Yearly</a></div>--}}
{{--                                        </div>--}}
{{--                                    </td>--}}
...
{{--                                                <div class="drop-menu"><i class="icon-more-alt"></i></div>--}}
{{--                                            </button>--}}
{{--                                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdownes1"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item"--}}
{{--                                                                                                                                                                          href="#">Monthly</a><a--}}
{{--                                                    class="dropdown-item" href="#">Yearly</a></div>--}}
{{--                                        </div>--}}
{{--                                    </td>--}}
...
{{--                                                <div class="drop-menu"><i class="icon-more-alt"></i></div>--}}
{{--                                            </button>--}}
{{--                                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdownes2"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item"--}}
{{--                                                                                                                                                                          href="#">Monthly</a><a--}}
{{--                                                    class="dropdown-item" href="#">Yearly</a></div>--}}
{{--                                        </div>--}}
{{--                                    </td>--}}
...
{{--                                                <div class="drop-menu"><i class="icon-more-alt"></i></div>--}}
{{--                                            </button>--}}
{{--                                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdownes3"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item"--}}
{{--                                                                                                                                                                          href="#">Monthly</a><a--}}
{{--                                                    class="dropdown-item" href="#">Yearly </a></div>--}}
{{--                                        </div>--}}
{{--                                    </td>--}}
...
{{--                                    </svg>--}}
{{--                                </button>--}}
{{--                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown4"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a--}}
{{--                                        class="dropdown-item" href="#">Yearly</a></div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                                    </div>--}}
{{--                                </button>--}}
{{--                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"><a class="dropdown-item" href="#">11 Aug - 21 Aug</a><a class="dropdown-item"--}}
{{--                                                                                                                                                                          href="#">07 Sep - 23 Sep</a><a--}}
...
{{--                                    </svg>--}}
{{--                                </button>--}}
{{--                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown5"><a class="dropdown-item" href="#">Weekly </a><a class="dropdown-item"--}}
{{--                                                                                                                                                             href="#">Monthly</a><a--}}
{{--                                        class="dropdown-item" href="#">Yearly </a></div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                    </svg>--}}
{{--                                </button>--}}
{{--                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown22"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item"--}}
{{--                                                                                                                                                             href="#">Monthly</a><a--}}
{{--                                        class="dropdown-item" href="#">Yearly </a></div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                    </svg>--}}
{{--                                </button>--}}
{{--                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown9"><a class="dropdown-item" href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a--}}
{{--                                        class="dropdown-item" href="#">Yearly </a></div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
@section('AddScript')
{{--    <script src="{{defPortalAssets('js/chart/morris-chart/raphael.js') }}"></script>--}}
{{--    <script src="{{defPortalAssets('js/chart/morris-chart/morris.js') }}"></script>--}}
{{--    <script src="{{defPortalAssets("js/chart/morris-chart/prettify.min.js") }}"></script>--}}
{{--    <script src="{{defPortalAssets("js/chart/apex-chart/apex-chart.js") }}"></script>--}}
{{--    <script src="{{defPortalAssets('js/chart/apex-chart/stock-prices.js') }}"></script>--}}
{{--    <script src="{{defPortalAssets("js/chart/apex-chart/moment.min.js") }}"></script>--}}
{{--    <script src="{{defPortalAssets("js/notify/bootstrap-notify.min.js") }}"></script>--}}
{{--    <script src="{{defPortalAssets("js/dashboard/default.js") }}"></script>--}}
{{--    <script src="{{defPortalAssets("js/notify/index.js") }}"></script>--}}
{{--    <script src="{{defPortalAssets("js/datatable/datatables/jquery.dataTables.min.js") }}"></script>--}}
{{--    <script src="{{defPortalAssets("js/datatable/datatables/datatable.custom.js") }}"></script>--}}
{{--    <script src="{{defPortalAssets("js/datatable/datatables/datatable.custom1.js") }}"></script>--}}
...
{{--    <script src="{{defPortalAssets("js/typeahead/handlebars.js") }}"></script>--}}
{{--    <script src="{{defPortalAssets("js/typeahead/typeahead.bundle.js") }}"></script>--}}
{{--    <script src="{{defPortalAssets("js/typeahead/typeahead.custom.js") }}"></script>--}}
{{--    <script src="{{defPortalAssets("js/typeahead-search/handlebars.js") }}"></script>--}}
{{--    <script src="{{defPortalAssets("js/typeahead-search/typeahead-custom.js") }}"></script>--}}
{{--    <script src="{{defPortalAssets("js/height-equal.js") }}"></script>--}}
