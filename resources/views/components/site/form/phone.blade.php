<div class="form-group col-lg-{{$col}} {{$style}} MobilePhone">
    @if ($labelview)
...
@section('AddStyle')
    {!! (new \App\Helpers\MinifyTools)->MinifyCss('intlTelInput/css/intlTelInput.css',"Seo",$cssReBuild) !!}
    {!! (new \App\Helpers\MinifyTools)->MinifyCss('intlTelInput/css/custom.css',"Seo",$cssReBuild) !!}
@endsection
